...
def generate_index_html(latest_content):
    """Generates the standalone HTML Dashboard with forced logo color override."""
...
<head>
    ...
    <style>
        ...
        body {{ font-family: -apple-system, system-ui, sans-serif; background: var(--bg); color: var(--text); margin: 0; transition: background 0.3s, color 0.3s; line-height: 1.5; }}
        .nav {{ background: var(--card); border-bottom: 1px solid var(--border); padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center; position: sticky; top: 0; z-index: 100; transition: background 0.3s; }}
        ...
        /* DARK MODE LOGO (Forced Override) */
...
def fetch_and_save_news():
    ...
    try:
        ...
        if response.text:
            ...
            print("✅ Processed and HTML generated.")
